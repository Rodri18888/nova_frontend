      ...
      <div className="text-center animate-in">
        <div className="relative inline-block mb-8">
          ...
          <img
            src="/nova-logo.png"
            alt="NOVA"
            className="relative w-24 h-24 rounded-2xl object-cover mx-auto shadow-2xl ring-1 ring-primary/40"
          />
        </div>
        <h1 className="text-4xl font-light text-foreground tracking-[0.3em] mb-3">
          NOVA
        </h1>
        <div className="w-16 h-px bg-gradient-to-r from-transparent via-primary/60 to-transparent mx-auto mb-4" />
        <p className="text-xs text-primary/80 tracking-[0.2em] uppercase">
          Sistema de Ventas
        </p>
                ...
                <Layout user={user} onLogout={handleLogout}>
                  <div className="animate-in">
                    <Routes>
                      ...
                      <Route
                        path="/devoluciones"
                        element={<Devoluciones user={user} />}
                      />
                      <Route path="/caja" element={<Caja user={user} />} />
                      <Route
                        path="/compras"
                        element={<Compras user={user} />}
                      />
